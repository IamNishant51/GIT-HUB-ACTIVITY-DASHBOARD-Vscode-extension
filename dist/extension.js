                    ...
                    switch (message.command) {
                        case 'openRepo':
                            try {
                                ...
                                const repoPanel = vscode.window.createWebviewPanel('githubRepo', `${repoOwner}/${repoName}`, vscode.ViewColumn.One, {
                                    enableScripts: true,
                                    retainContextWhenHidden: true
                                });
                                ...
                                repoPanel.webview.html = getRepoWebviewContent(repoData.data, contents.data, repoOwner, repoName);
                            }
                            catch (error) {
...
function getLoadingWebviewContent(title) {
    return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
function getRepoWebviewContent(repoData, contents, owner, repoName) {
    return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
